...
|修改|按钮|弹出层显示修改企业页面|||点击“修改”按钮，弹出层显示修改企业页面，详见2.1.3修改/删除企业|
|删除|按钮|弹出层显示删除确认页面|||点击“删除”按钮，弹出层显示删除确认页面，详见2.1.3修改/删除企业|
...
|AppEUI|文字显示||||根据选择地区，自动分配AppEUI并显示在该行，AppEUI全网唯一性。|
